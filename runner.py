...
chase.add_account(123, 600, account_details = Account(12, "Tim", "23rd Street"))
...
chase.add_account(Account(123, 400))
print(chase.accounts[0].balance)
print(chase.accounts[0].account_details)
chase.add_ownership(123, 15, "Tim", "23rd Street")
